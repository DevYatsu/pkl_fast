...
use crate::parser::utils::{cut_multispace1, expected, line_ending_or_end};
...
fn cut_module_value<'source>(input: &mut &'source str) -> PResult<&'source str> {
...
fn module_value<'source>(input: &mut &'source str) -> PResult<&'source str> {
    repeat(
        1..,
