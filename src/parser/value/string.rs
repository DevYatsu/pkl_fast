        ...
        for (char_index, c) in initial_string.char_indices() {
            ...
            match c {
                '\\' => {
                    ...
                    if let Some(after_backslash) = initial_string.chars().nth(char_index + 1) {
                        match after_backslash {
                                        ...
                                        if open_paren_count == 0 {
                                            ...
                                            if result.is_err() {
                                                let string_in_main_str =
                                                    &initial_string[char_index..char_index + 2 + i];
                            ...
                            'u' => {
                                ...
                                if let Some(next_char) = initial_string.chars().nth(char_index + 2)
                                {
